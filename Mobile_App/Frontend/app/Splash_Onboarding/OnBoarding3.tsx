...
const Onboarding2 = () => {
  ...
  const handleNext = () => {
    // navigation.navigate("Splash_Onboarding/Location")
  ...
  return (
    <View style={globalStyles.container}>
      ...
      >
        <Text>
          Secure Transactions, Personalized Dashboards
      ...
      >
        <Text>
          Experience trusted payments and tailored dashboards for vendors, buyers, and transporters
